...
class Cart
{
     ...
     * Cart constructor.
     *
     * @param \Royalcms\Component\Session\SessionManager      $session
     ...
     * @param float     $price
     * @param array     $options
     * @return \Royalcms\Component\Shoppingcart\CartItem
     */
    ...
    private function getConnection()
    {
        ...
        return royalcms(DatabaseManager::class)->connection($connectionName);
    }
