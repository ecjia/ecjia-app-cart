...
class tangchi_storebuy_flow_done_module extends api_front implements api_interface
{
    public function handleRequest(\Royalcms\Component\HttpKernel\Request $request)
    {
		...
		RC_DB::table('cart')->whereIn('rec_id', $cart_id)->update(array('rec_type' => $flow_type));
